                ...
                @if(count($desserts)>0)
                    @foreach ($desserts as $dessert)
                        <div class="pricing-entry d-flex ftco-animate">
                            <div class="img" style="background-image: url({{ asset('images/products/desserts/'.$dessert->image) }});"></div>
                            <div class="desc pl-3">
        	...
        	<div class="col-md-6">
                ...
                @if(count($drinks)>0)
                    @foreach ($drinks as $drink)
                        <div class="pricing-entry d-flex ftco-animate">
                            <div class="img" style="background-image: url({{ asset('images/products/drinks/'.$drink->image) }});"></div>
                            <div class="desc pl-3">
                                <div class="d-flex text align-items-center">
                            ...
                            @if(count($drinks)>0)
                                @foreach ($drinks as $drink)
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="#" class="menu-img img mb-4" style="background-image: url({{ asset('images/products/drinks/'.$drink->image) }});"></a>
                                            <div class="text">
		              ...
		              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
		                <div class="row">
                            ...
                            @foreach ($desserts as $dessert)
                                <div class="col-md-4 text-center">
                                    <div class="menu-wrap">
                                        <a href="#" class="menu-img img mb-4" style="background-image: url({{ asset('images/products/desserts/'.$dessert->image) }});"></a>
                                        <div class="text">
